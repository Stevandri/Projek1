    ...
    <div class="container mt-5">
        ...
        <article>
            ...
            <header class="article-header text-center mb-5">
                <h2>Keberhasilan Blue Choir Fakultas Teknik Unsrat dalam PICF 2024</h2>
            ...
            <!-- Paragraf: Berita Utama -->
            <section class="content-section">
                <p class="content-text">
                    Blue Choir Fakultas Teknik Universitas Sam Ratulangi (Unsrat) berhasil meraih dua medali emas dalam ajang Pacific International Choral Festival (PICF) 2024 yang diselenggarakan di Indonesia. Keberhasilan ini menjadi bukti nyata dari dedikasi dan kualitas luar biasa yang dimiliki oleh para anggota Blue Choir, yang telah bekerja keras untuk mengharumkan nama Unsrat dan Indonesia di kancah internasional. Selain memperoleh dua medali emas, Blue Choir Unsrat juga meraih berbagai penghargaan atas kualitas penampilan yang luar biasa, menandakan bahwa mereka tidak hanya bersaing dengan choir dari Indonesia, tetapi juga dengan berbagai choir dari negara lain. Pencapaian ini menjadi simbol dari perjuangan panjang, tantangan, dan semangat yang ditunjukkan oleh setiap anggota Blue Choir, serta menjadi inspirasi bagi mahasiswa lainnya untuk mengejar prestasi di bidang seni dan budaya. Keberhasilan ini tidak hanya memberikan kebanggaan bagi Fakultas Teknik Unsrat, tetapi juga menjadi salah satu prestasi gemilang yang memperlihatkan bahwa Indonesia memiliki potensi besar dalam dunia seni paduan suara internasional.
                </p>
                <!-- Gambar dan Link -->
                <a href="https://fatek.unsrat.ac.id/blue-choir-raih-gold-medal-pada-11th-bali-international-choir-festival-2022/">
                    <img src="https://fatek.unsrat.ac.id/wp-content/uploads/2022/07/WhatsApp-Image-2022-07-28-at-7.35.13-AM-1024x768.jpeg" class="img-fluid" alt="Bali International Choir Festival 2022" />
                </a>
            </section>
        </article>
    </div>
