          ...
          <div class="card shadow-sm">
            <div class="row g-0">
              ...
              <div class="col-md-4 d-flex justify-content-center align-items-center p-4">
                <img 
                  src="../../../allacces/Kepengurusan2025/Item/kewira/ping.png" 
                  alt="Foto Profil" 
              ...
              <div class="col-md-8">
                <div class="card-body">
                  <h3 class="card-title mb-3">{{ Auth::user()->namadepan }}</h3>
                  <p class="card-text mb-2"><strong>Posisi Suara: </strong> Bass 1</p>
