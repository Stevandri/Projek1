...
@media (max-width: 576px) {
  ...
  <body>
			...
			<nav id="sidebar" class="min-vh-100">
	          ...
	          <span class="sr-only">Toggle Menu</span>
				...
				<div class="p-4 zindexatas">
		  		<h1><a href="index.html" class="logo">Blue Choir <span>> Partitur</span></a></h1>
    ...
    <!-- Judul Halaman -->
    <h2 class="text-dark">Partitur</h2>
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-3 mb-4">
                <div class="card">
                    <img src="cover/i_will_lift_mine_eyes.png" class="card-img-top" alt="Book 1">
                    <div class="card-body">
                        <h5 class="card-title">I Will Lift Mine</h5>
                        <p class="card-text">Jake Runestad</p>
                        <a href="path/to/file1.pdf" class="btn btn-primary" download>Unduh PDF</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-4">
                <div class="card">
                    <img src="cover/Orde-e.png" class="card-img-top" alt="Book 2">
                    <div class="card-body">
                        <h5 class="card-title">Orde-E</h5>
                        <p class="card-text">Lester Delgado</p>
                        <a href="path/to/file2.pdf" class="btn btn-primary" download>Unduh PDF</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-4">
                <div class="card">
                    <img src="cover/paris-barantai.png" class="card-img-top" alt="Book 3">
                    <div class="card-body">
                        <h5 class="card-title">Paris Barantai</h5>
                        <p class="card-text">Ken Steven</p>
                        <a href="path/to/file3.pdf" class="btn btn-primary" download>Unduh PDF</a>
                    </div>
                </div>
            </div>
        </div>
