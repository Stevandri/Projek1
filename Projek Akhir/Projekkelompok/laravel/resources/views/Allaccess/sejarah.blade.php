...
<body>
    ...
    <!--Judul-->
    <section class="text-center sejarahimg" data-aos="fade-down">
        <div class="container">
          <div class="row py-3">
            <div class="col-lg-9 col-xl-8 ms-auto me-auto pb-5 pt-5">
              <h1 class="display-2 fw-bold mb-3 text-light ">Sejarah Blue Choir</h1>
              <h5 class="text-light">Harmoni Suara, Jiwa yang Bersatu</h5>
              <div class="mt-5">
              </div>
            </div>
          </div>
      ...
      <section class="py-5" >
        <div class="container"  >
          <div class="row align-items-center pt-5 pb-md-5" data-aos="fade-up" >
            <div class="col-md-5 mb-3 mb-md-0"  >
              <img alt="image" class="img-fluid rounded-3 shadow-lg" src="../allacces/Artikel/Sejarah/img/FOTO1.jpg"  >
            </div>
            <div class="col-12 m-md-auto col-md-7 col-xl-5"  >
              <h2 class="mb-3 fw-semibold" >Bagaimana Blue Choir berdiri</h2>
              <p class="lead" >Blue Choir didirikan pada tahun 1989 dengan nama “Biro Paduan Suara Mahasiswa Fakultas Teknik”, dan secara resmi menjadi organisasi kemahasiswaan Fakultas Teknik Universitas Sam Ratulangi 27 September 1996, dan mulai menggunakan nama “Blue Choir “ pada tahun 1999. </p>
              <a href="#" class="text-decoration-none" >Learn More</a>
            </div>
          </div>
          <div class="row align-items-center pt-5 pb-md-5"  data-aos="fade-up">
            <div class="col-md-5 m-md-auto order-md-5 mb-3 mb-md-0"  >
              <img alt="image" class="img-fluid rounded-3 shadow-lg" src="../allacces/Artikel/Sejarah/img/FOTO2.jpg"  >
            </div>
            <div class="col-12 col-xl-5 col-md-7"  >
              <h2 class="mb-3 fw-semibold" >Melahirkan penyanyi profesional</h2>
              <p class="lead" >Paduan suara saat ini memiliki sekitar 60 penyanyi dari empat jurusan termasuk teknik sipil , arsitektur , teknik mesin dan teknik elektro dengan informatika bergabung pada tahun 2007 kemudian Perencanaan wilayah dan kota bergabung pada tahun 2008 dan mereka menampilkan repertoar yang luas dari karya-karya Latin hingga lagu-lagu Asia dan Barat Kontemporer.</p>
              <a href="#" class="text-decoration-none" >Learn More</a>
            </div>
          </div>
          <div class="row align-items-center pt-5 pb-md-5"  data-aos="fade-up">
            <div class="col-md-5 mb-3 mb-md-0"  >
              <img alt="image" class="img-fluid rounded-3 shadow-lg" src="../allacces/Artikel/Sejarah/img/FOTO3.jpg"  >
            </div>
            <div class="col-12 m-md-auto col-xl-5 col-md-7"  >
              <h2 class="mb-3 fw-semibold" >Mengukir Banyak Prestasi</h2>
              <p class="lead" >Paduan suara juga sering mengikuti kompetisi paduan suara nasional dan internasional dan mengadakan konser di berbagai gereja sepanjang tahun. Saat ini, Blue Choir telah terkenal sebagai salah satu paduan suara terbaik di Sulawesi Utara .</p>
              <a href="#" class="text-decoration-none" >Learn More</a>
            </div>
          </div>
        </div>
