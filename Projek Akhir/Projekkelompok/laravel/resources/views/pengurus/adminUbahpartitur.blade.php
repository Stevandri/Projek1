			...
			<nav id="sidebar" class="min-vh-100">
	          ...
	          <span class="sr-only">Toggle Menu</span>
				...
				<div class="p-4 zindexatas">
		  		<h1><a href="index.html" class="logo">Hallo Admin<span>> Partitur >Ubah Partitur</span></a></h1>
          ...
          <div class="row">
              <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                  ...
                  <div class="container mt-5">
                    <h1 class="mb-4">Ubah Partitur</h1>
                </div>
                ...
                <div class="container mt-5">
                    <!-- <?php
                        ...
                        $id = $_GET["id"];
                        $sql = "SELECT * FROM partitur WHERE id = $id";
                    ...
                    <form action="proses_ubah.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="<?php echo $row['sampul_path']; ?>" alt="Sampul" width="100" class="mt-2">
                        </div>
                        <button type="submit" class="btn btn-primary">Simpan Perubahan</button>
                    </form>
                    <?php
                        } else {
                            echo "Partitur tidak ditemukan.";
                        }
