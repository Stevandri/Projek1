...
<body>
  ...
  <div class="container mb-5" data-aos="fade-left">
    ...
    <div class="row mt-2 justify-content-center">
      <div class="col-md-8 col-lg-4 col-xl-3 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/artistik/clinton.png" class="rounded-circle" />
        <p class="mt-4 fw-semibold fs-6 mb-0">Clinton Lombogia - Koordinator</p>
        <p class="small">Informatika - 2021</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/artistik/met.png" class="rounded-circle" />
        <p class="mt-4 mb-0 fs-6 fw-semibold">Matthew Rarung - Anggota</p>
        <p class="small">Informatika - 2022</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/artistik/melan.png" class="rounded-circle" />
        <p class="mt-4 mb-0 fs-6 fw-semibold">Melany Br.Marpaung - Anggota</p>
        <p class="small">Perencanaan Wilayah dan Kota - 2022</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/artistik/cley.png" class="rounded-circle" />
  ...
  <div class="container mb-5" data-aos="fade-right">
    ...
    <div class="row mt-2 justify-content-center">
      <div class="col-md-8 col-lg-4 col-xl-3 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/pelatihan/3.png" class="rounded-circle" />
        <p class="mt-4 fw-semibold fs-6 mb-0">Trisonli Kawalo - Koordinator</p>
        <p class="small">Sipil - 2021</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/pelatihan/henok.png" class="rounded-circle" />
        <p class="mt-4 mb-0 fs-6 fw-semibold">Henoch Saroinsong - Anggota</p>
        <p class="small">Informatika - 2022</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/pelatihan/jes.png" class="rounded-circle" />
        <p class="mt-4 mb-0 fs-6 fw-semibold">Jessica Felicia - Anggota</p>
        <p class="small">Sipil - 2022</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/pelatihan/edo.png" class="rounded-circle" />
  ...
  <div class="container mb-5" data-aos="fade-left">
    ...
    <div class="row mt-2 justify-content-center">
      <div class="col-md-8 col-lg-4 col-xl-3 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/kenggotaan/eta.png" class="rounded-circle" />
        <p class="mt-4 fw-semibold fs-6 mb-0">Marieta Soo - Koordinator</p>
        <p class="small">Sipil - 2022</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/kenggotaan/tio.png" class="rounded-circle" />
        <p class="mt-4 mb-0 fs-6 fw-semibold">Christio Manangka - Anggota</p>
        <p class="small">Sipil - 2022</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/kenggotaan/mace.png" class="rounded-circle" />
        <p class="mt-4 mb-0 fs-6 fw-semibold">Putri Tuflasa - Anggota</p>
        <p class="small">Perencanaan Wilayah dan Kota - 2023</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/kenggotaan/chelsea.png" class="rounded-circle" />
  ...
  <div class="container mb-5" data-aos="fade-right">
    ...
    <div class="row mt-2 justify-content-center">
      <div class="col-md-8 col-lg-4 col-xl-3 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/Perlengkapan/dino.png" class="rounded-circle" />
        <p class="mt-4 fw-semibold fs-6 mb-0">Giliardino Mananeke - Koordinator</p>
        <p class="small">Informatika - 2022</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/Perlengkapan/dwi.png" class="rounded-circle" />
        <p class="mt-4 mb-0 fs-6 fw-semibold">Dwinov Hasugian - Anggota</p>
        <p class="small">Teknik Lingkungan - 2023</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/Perlengkapan/aldo.png" class="rounded-circle" />
        <p class="mt-4 mb-0 fs-6 fw-semibold">Geraldo Tumbelaka - Anggota</p>
        <p class="small">Elektro - 2024</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/Perlengkapan/zeec.png" class="rounded-circle" />
  ...
  <div class="container mb-5" data-aos="fade-left">
    ...
    <div class="row mt-2 justify-content-center">
      <div class="col-md-8 col-lg-4 col-xl-3 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/medok/aldo.png" class="rounded-circle" />
        <p class="mt-4 fw-semibold fs-6 mb-0">Ronaldo Tjiabrata - Koordinator</p>
        <p class="small">Informatika - 2021</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/medok/me.png" class="rounded-circle" />
        <p class="mt-4 mb-0 fs-6 fw-semibold">Stevandri V. Patty - Anggota</p>
        <p class="small">Informatika - 2024</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/medok/eca.png" class="rounded-circle" />
        <p class="mt-4 mb-0 fs-6 fw-semibold">Ezra Simauw</p>
        <p class="small">Informatika - 2024</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/medok/early.png" class="rounded-circle" />
  ...
  <div class="container mb-5" data-aos="fade-right">
    ...
    <div class="row mt-2 justify-content-center">
      <div class="col-md-8 col-lg-4 col-xl-3 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/Peribadatan/miaw.png" class="rounded-circle" />
        <p class="mt-4 fw-semibold fs-6 mb-0">Srikandi Pusung - Koordinator</p>
        <p class="small">Arsitektur - 2022</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/Peribadatan/andre.png" class="rounded-circle" />
        <p class="mt-4 mb-0 fs-6 fw-semibold">Andreas Mirah - Anggota</p>
        <p class="small">Arsitektur - 2023</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/Peribadatan/vani.png" class="rounded-circle" />
        <p class="mt-4 mb-0 fs-6 fw-semibold">Stevani Wuisan</p>
        <p class="small">Sipil - 2023</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/Peribadatan/tara.png" class="rounded-circle" />
  ...
  <div class="container mb-5" data-aos="fade-left">
    ...
    <div class="row mt-2 justify-content-center">
      <div class="col-md-8 col-lg-4 col-xl-3 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/kewira/ping.png" class="rounded-circle" />
        <p class="mt-4 fw-semibold fs-6 mb-0">Christiani Lantang - Koordinator</p>
        <p class="small">Informatika - 2022</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/kewira/sweet.png" class="rounded-circle" />
        <p class="mt-4 mb-0 fs-6 fw-semibold">Sweetly Manopo - Anggota</p>
        <p class="small">Informatika - 2022</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 pt-5 pt-lg-0 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/kewira/jess.png" class="rounded-circle" />
        <p class="mt-4 mb-0 fs-6 fw-semibold">Jessica Keintjiem</p>
        <p class="small">Sipil - 2022</p>
      </div>
      <div class="col-md-8 col-lg-4 col-xl-3 m-auto text-center">
        <img alt="image" style="width:160px; height: 160px;" src="Item/kewira/oyen.png" class="rounded-circle" />
