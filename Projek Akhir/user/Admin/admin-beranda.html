                  ...
                  <div class="row">
                      <div class="col-md-4">
                          <div class="card bg-primary text-white mb-4">
                              <div class="card-body">
                                  <h5><b>Total Pengguna</b></h5>
                                  <p class="card-text display-2">56</p>
                              </div>
                          </div>
                      </div>
                      <div class="col-md-4">
                          <div class="card bg-success text-white mb-4">
                              <div class="card-body">
                                  <h5><b>Pengguna Online</b></h5>
                                  <p class="card-text display-2">20</p>
                              </div>
                          </div>
                      </div>
                  </div>
  
                  <h2>Pengguna Online</h2>
